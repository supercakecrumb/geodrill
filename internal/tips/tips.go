// Package tips builds post-answer recognition tips for the language decks:
// curated per-language "tells" (characteristic letters, digraphs, words,
// scripts) matched against the actual sentence shown, plus contrast notes
// for classic confusion pairs. It plugs into engram's quiz.TipProvider via
// Provider().
package tips
