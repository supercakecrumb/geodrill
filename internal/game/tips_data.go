...
// miner in the repo (tips_mine_test.go).

// tipDecks lists the deck slugs (seeds/decks.yaml, also a group topic's
// slug under languages/guess-the-language) whose languages have a curated +
// corpus-audited cue set. Tips are rolled out deck by deck — extend this
// (and tells) together when a new group is ready.
